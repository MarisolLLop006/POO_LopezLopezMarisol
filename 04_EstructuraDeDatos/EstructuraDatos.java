                    ...
                    static void Main()
                        {
                            ...
                            float anchura;
                            anchura = insert.Parse(Console.ReadLine());
                            Console.Write("Entra la altura del rectángulo:");
                            float altura;
                            altura = insert.Parse(Console.ReadLine());
                            float area = altura*anchura;
                            float perimetro = (altura*2)+(anchura*2);
                            Console.WriteLine("El área del rectángulo es: "+area("f2")+
                            " y el perémetro es: "+ perimetro("F2");
                        }
                    }
                    ...
                    */ 
                    class CalculoFactorial
                    {
                        class Program
                        {
                            ...
                            {
                                int num;
                                Consola.WriteLine("Calculo del Factorial de un número entero positivo\n");
                                do
                                {
                                    Consola.Write("Por favor Digite un número entero positivo: ");
                                    num = int.Parse(consola.ReadLine());
                                    verificar(num);
                                } while (num < 0);
                                factorial(num);
                                Consola.ReadKey();
